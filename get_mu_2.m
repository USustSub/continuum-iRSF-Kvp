...
function [sin_phi_,Vp,Eii_p,theta_n] = get_mu_2 ( dg_2 , dQdsigma_ , dt , inx , deltaY , b_ ,  theta_ , hhhh)
mu0 = 0.2 ; 
V0 = 4e-9 ;  % m/s
a_ = 0.01 ;
L_ = 0.01 ;
        ...
        dlambda_dot = dg_2/dt+i*hhhh ; 
        depsp = [dlambda_dot.*dQdsigma_(:,1) dlambda_dot.*dQdsigma_(:,2) dlambda_dot.*dQdsigma_(:,3) dlambda_dot.*dQdsigma_(:,4)];
