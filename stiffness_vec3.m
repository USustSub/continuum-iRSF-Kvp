...
%             dYY = node_dist(:,1)/2+node_dist(:,2)/2;
%             dYY(dYY==0) = 1 ; 
%             dXX = node_dist(:,3)/2+node_dist(:,4)/2;
%             dXX(dXX==0) = 1 ; 
            ...
            dXX_ = [dXX ; dXX ; dXX ; dXX ]; 
            dYY_ = [dYY ; dYY ; dYY ; dYY ]; 
%             dXX_ = dXX ; 
%             dYY_ = dYY ; 
            ...
            for hhh_ = 1 : size(Bx,2)
                f1__= (D11_.*Bx(:,hhh_)+D13_.*By(:,hhh_))./dXX_;
                f2__= (D12_.*By(:,hhh_)+D13_.*Bx(:,hhh_))./dXX_;
                FX(:,hhh_*2-1:hhh_*2) = [ f1__ f2__];
                
                f1__= (D31_.*Bx(:,hhh_)+D33_.*By(:,hhh_))./dXX_;
                f2__= (D32_.*By(:,hhh_)+D33_.*Bx(:,hhh_))./dXX_;
                FY(:,hhh_*2-1:hhh_*2) = [ f1__ f2__];
                
                f1__= (D31_.*Bx(:,hhh_)+D33_.*By(:,hhh_))./dYY_;
                f2__= (D32_.*By(:,hhh_)+D33_.*Bx(:,hhh_))./dYY_;
                FX2(:,hhh_*2-1:hhh_*2) = [ f1__ f2__];
                
                f1__= (D21_.*Bx(:,hhh_)+D23_.*By(:,hhh_))./dYY_;
                f2__= (D22_.*By(:,hhh_)+D23_.*Bx(:,hhh_))./dYY_;
...
%             for hhh_ = 1 : size(Bx,2)
%                 f1__= (D11_.*Bx(:,hhh_)+D13_.*By(:,hhh_))/dXX;
%                 f2__= (D12_.*By(:,hhh_)+D13_.*Bx(:,hhh_))/dXX;
...
%                 
%                 f1__= (D31_.*Bx(:,hhh_)+D33_.*By(:,hhh_))/dXX;
%                 f2__= (D32_.*By(:,hhh_)+D33_.*Bx(:,hhh_))/dXX;
%                 en1__ = En(1:numnode,hhh_*2-1); en1__(en1__==0) = 1;
%                 en2__ = En(1:numnode,hhh_*2); en2__(en2__==0) = 1;
%                 GY(:,en1__) = GY(:,en1__) + f1__ ;
%                 GY(:,en2__) = GY(:,en2__) + f2__ ;
%                 
%                 f1__= (D31_.*Bx(:,hhh_)+D33_.*By(:,hhh_))/dYY;
%                 f2__= (D32_.*By(:,hhh_)+D33_.*Bx(:,hhh_))/dYY;
%                 en1__ = En(1:numnode,hhh_*2-1); en1__(en1__==0) = 1;
%                 en2__ = En(1:numnode,hhh_*2); en2__(en2__==0) = 1;
%                 GX2(:,en1__) = GX2(:,en1__) + f1__ ;
%                 GX2(:,en2__) = GX2(:,en2__) + f2__ ;
% 
%                 f1__= (D21_.*Bx(:,hhh_)+D23_.*By(:,hhh_))/dYY;
%                 f2__= (D22_.*By(:,hhh_)+D23_.*Bx(:,hhh_))/dYY;
%                 en1__ = En(1:numnode,hhh_*2-1); en1__(en1__==0) = 1;
%                 en2__ = En(1:numnode,hhh_*2); en2__(en2__==0) = 1;
