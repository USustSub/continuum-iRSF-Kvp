...
fprintf(results_vtu, '<Piece  NumberOfPoints="  %12.8g" NumberOfCells=" %12.8g"> \n', numNodes, numCells);
...
if( dof_per_vertex == 1)
    fprintf(results_vtu, '<PointData  Scalars="DAMAGE"> \n');
...
fprintf(results_vtu, '<DataArray  type="Float64"  Name="Disp" NumberOfComponents="3" format="ascii"> \n');
