...
%{
nnx = 64 ; nny = 2*25 ; 
% node1 = square_node_array([0 0],[L 0],[L D/3],[0 D/3],nnx,nny);
% node2 = square_node_array([0 D/3+L/nny/5],[L D/3+L/nny/5],[L 2*D/3-L/nny/5],[0 2*D/3-L/nny/5],2*nnx-1,2*nny);
% node3 = square_node_array([0 2*D/3],[L 2*D/3],[L 3*D/3],[0 3*D/3],nnx,nny);

node1 = square_node_array([0 0],[L 0],[L D/3],[0 D/3],nnx,nny);
node2 = square_node_array([0 D/3+L/nny/5],[L D/3+L/nny/5],[L 2*D/3-L/nny/5],[0 2*D/3-L/nny/5],4*nnx-3,2*nny);
node3 = square_node_array([0 2*D/3],[L 2*D/3],[L 3*D/3],[0 3*D/3],nnx,nny);

% node1 = square_node_array([0 0],[L 0],[L D/2-D/10],[0 D/2-D/10],nnx,nny);
% node2 = square_node_array([0 D/2-D/10+L/nny/5],[L D/2-D/10+L/nny/5],[L D/2+D/10-L/nny/5],[0 D/2+D/10-L/nny/5],2*nnx-1,2*nny);
% node3 = square_node_array([0 D/2+D/10],[L D/2+D/10],[L D],[0 D],nnx,nny);
...
axis equal
hold on
% plot(node2(:,1),node2(:,2),'bsq')
% plot(node1(:,1),node1(:,2),'k.')

% dmax  = 1.05 ;              % radius = dmax * nodal spacing
...
% nnx = ii_ ; nny = ii_ ; 
load data_11_3.mat node element
numnode = size(node,1) ; 
% figure
% hold on
% % plot_mesh(node,element,'T3','k-')
...
p0 = 1e6*15.2*0.33 ; % initial pressure
